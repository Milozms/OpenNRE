...
data_path = "./origin_data/KBP/"
# files to export data
export_path = "./data/KBP/"
...
def init_train_files(name):
	...
	for s in range(total):
		...
		tup = (en1_name,en2_name,relation)
...
def init_test_files(name):
	...
	for s in range(total):
		...
		ss.append((en1_name + '\t' + en2_name + '\t' + rel_name, sentence, en1_name, en2_name, en1_name, en2_name, rel_name))
