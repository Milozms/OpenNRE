...
# do
    ...
    do
        mkdir ./checkpoint/$model/lr$lr-dp$dropout
        echo "learning rate = $lr"
        echo "dropout = $dropout"
        CUDA_VISIBLE_DEVICES=$devices python train.py --model_name $model --learning_rate $lr --drop_prob $dropout --checkpoint_dir ./checkpoint/$model/lr$lr-dp$dropout > ./checkpoint/$model/lr$lr-dp$dropout/train_log.txt
